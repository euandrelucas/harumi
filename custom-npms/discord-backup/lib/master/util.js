					...
					return __awaiter(_this, void 0, void 0, function () {
						...
						return __generator(this, function (_b) {
							...
							case 0:
								...
								messageCount = isNaN(options.maxMessagesPerChannel)
									? 10
							...
							case 3:
								...
								fetched.forEach(function (msg) {
									if (
										!msg.author ||
											channelData.messages.length >= messageCount
									) {
										fetchComplete = true;
										return;
									}
	...
	return __awaiter(this, void 0, void 0, function () {
		...
		return __generator(this, function (_a) {
			return [
				...
				new Promise(function (resolve) {
					guild.channels
						.create(categoryData.name, { type: 'category' })
								...
								return __generator(this, function (_a) {
									...
									case 0:
										...
										categoryData.permissions.forEach(function (perm) {
											var role = guild.roles.cache.find(function (r) {
										...
										return [
											4 /*yield*/,
											category.overwritePermissions(finalPermissions)
										];
									case 1:
										_a.sent();
						...
						return __generator(this, function (_a) {
							...
							if (channelData.type === 'text') {
								...
								while (bitrate > maxBitrate[guild.premiumTier]) {
									bitrate =
										maxBitrate[maxBitrate.indexOf(guild.premiumTier) - 1];
								}
									...
									return __awaiter(_this, void 0, void 0, function () {
										...
										return __generator(this, function (_a) {
											...
											case 0:
												...
												return [
													4 /*yield*/,
													channel.overwritePermissions(finalPermissions)
												];
											case 1:
												_a.sent();
												/* Load messages */
