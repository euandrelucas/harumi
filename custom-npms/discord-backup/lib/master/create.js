		...
		return __generator(this, function (_a) {
			...
			guild.roles.cache
				...
				.forEach(function (role) {
					if (
						role.id !== (guild.roles.everyone ? guild.roles.everyone.id : '')
					) {
				...
				return __awaiter(_this, void 0, void 0, function () {
					...
					return __generator(this, function (_b) {
						...
						case 0:
							...
							return [
								4 /*yield*/,
								node_fetch_1.default(emoji.url).then(function (res) {
									return res.buffer();
								})
							];
						case 1:
					...
					return __awaiter(_this, void 0, void 0, function () {
						...
						return __generator(this, function (_c) {
							...
							case 2:
								...
								return [
									4 /*yield*/,
									util_1.fetchTextChannelData(child, options)
								];
							case 3:
								channelData = _c.sent();
								...
								return [3 /*break*/, 6];
							case 4:
								return [4 /*yield*/, util_1.fetchVoiceChannelData(child)];
							case 5:
								channelData = _c.sent();
								categoryData.children.push(channelData); // And then push the child in the categoryData
								_c.label = 6;
							...
							case 10:
								...
								return [
									4 /*yield*/,
									util_1.fetchTextChannelData(channel, options)
								];
							case 11:
								channelData = _c.sent();
								...
								return [3 /*break*/, 14];
							case 12:
								return [4 /*yield*/, util_1.fetchVoiceChannelData(channel)];
							case 13:
								channelData = _c.sent();
								channels.others.push(channelData); // Update channels object
								_c.label = 14;
